...
public final class ApiDtos {
    ...
    public record Settlement(String RoomID, String KommandantUUID, int cargoShipsSunk,
                             int uBoatsSunk, int totalTonnage) {
    }
    ...
    public record PlayerRecordSummary(int cargoShipsSunk, int uBoatsSunk, int totalTonnage, int gamesPlayed) {
    }

    public record PlayerGameRecord(String RoomID, String state, String reason, int cargoShipsSunk,
                                   int uBoatsSunk, int totalTonnage, int roomCargoShipsSunk,
                                   int totalCargoShips, String updatedAt) {
    }
}
